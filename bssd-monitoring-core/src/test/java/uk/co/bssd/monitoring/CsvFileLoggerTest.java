...
public class CsvFileLoggerTest {
	...
	public static void beforeClass() {
		...
		logger1 = new CsvFileLogger<Integer>(FILENAME_1);
		logger1.report(REPORTED_VALUE_1);
		
		logger2 = new CsvFileLogger<Integer>(FILENAME_2);
	}
	...
	public void testFirstValueIsTimestamp() {
		...
		DateTime timestamp = timestampFormatter.parseDateTime(timestamp(firstLine(file1())));
